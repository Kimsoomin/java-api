...
public class StringDemo {
	public static void main(String[] args) {
		...
		if (s1 == s2) {
			System.out.println("s1과 s2는 밸류는 같고,[주소값] 같다");
		} else {
			System.out.println("s1과 s2는 밸류는 다르고,[주소값] 다르다");
		}
		String s3 = new String("한빛"), s4 = new String("한빛");	// 생성자 
		// 위 구문은 메모리 낭비를 초래하므로 비추
		if (s3 == s4) {
			System.out.println("s3과 s4는 밸류는 같고,[주소값] 같다");
		} else {
			System.out.println("s3과 s4는 밸류는 다르고,[주소값]다르다");
		}
